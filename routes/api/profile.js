...
router.get(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id })
      //get more data which connect profile and user collection inside model
      .populate("user", ["name", "avatar"])
      .then(profile => {
        if (!profile) {
          errors.noprofile = "No profile set up yet";
...
// @desc    Add experirience to profile
// @access  Private
router.post(
  "/experience",
  passport.authenticate("jwt", { session: false }),
...
// @desc    Delete experirience to profile
// @access  Private
router.delete(
  "/experience/:exp_id",
  passport.authenticate("jwt", { session: false }),
...
// @desc    Delete user profile profile
// @access  Private
